...
function w(t) {
  ...
  return null !==
    (s =
      null ===
        (n =
          null === (e = t.head) || void 0 === e
            ? void 0
            : e.querySelector('meta[name="csp-nonce"]')) || void 0 === n
        ? void 0
        : n.getAttribute("content")) && void 0 !== s
    ? s
    : void 0;
}
const g = (t, e, ...n) => {
        ...
        for (let n = 0; n < e.length; n++)
          (s = e[n]),
            Array.isArray(s)
              ...
              : null != s &&
                "boolean" != typeof s &&
                ((r = "function" != typeof t && !b(s)) && (s = String(s)),
                r && i ? (a[a.length - 1].t += s) : a.push(r ? v(null, s) : s),
                (i = r));
      };
    if ((c(n), e)) {
  ...
  C = (t) => {
    if ("function" == typeof t.vtag) {
      ...
      return (
        ...
        g(t.vtag, e, ...(t.vchildren || []))
      );
    }
    const e = v(t.vtag, t.vtext);
    return (
      (e.l = t.vattrs), (e.o = t.vchildren), (e.i = t.vkey), (e.u = t.vname), e
    );
  },
  M = (t, e) =>
    null == t || b(t)
  ...
  U = (t, e, n) => {
    ...
    Ht && n
      ? ((s = s || new CSSStyleSheet()),
        "string" == typeof s ? (s = e) : s.replaceSync(e))
      : (s = e),
      Nt.set(t, s);
  },
  E = (t, e, n, s) => {
    ...
    if (((t = 11 === t.nodeType ? t : Wt), r))
      if ("string" == typeof r) {
        ...
        t.adoptedStyleSheets.includes(r) ||
  ...
  F = (t, e, n, s, l, o) => {
    if (n !== s) {
      ...
      if ("class" === e) {
        ...
        let c = !1;
        i !== (i = i.replace(/^xlink\:?/, "")) && ((e = i), (c = !0)),
          null == s || !1 === s
            ? (!1 === s && "" !== t.getAttribute(e)) ||
              (c ? t.removeAttributeNS(h, e) : t.removeAttribute(e))
            : (!r || 4 & o || l) &&
              !a &&
              ((s = !0 === s ? "" : s),
              c ? t.setAttributeNS(h, e, s) : t.setAttribute(e, s));
      } else
        (e =
          "-" === e[2]
            ? e.slice(3)
  ...
  H = (t, o, r, a) => {
    ...
    if (
      (l ||
        ((c = !0),
        "slot" === h.p &&
          (e && a.classList.add(e + "-s"), (h.h |= h.o ? 2 : 1))),
      null !== h.t)
    )
      u = h.m = Wt.createTextNode(h.t);
    else if (1 & h.h) u = h.m = Wt.createTextNode("");
    else {
      if (
        (i || (i = "svg" === h.p),
        (u = h.m = Wt.createElementNS(i ? y : m, 2 & h.h ? "slot-fb" : h.p)),
        i && "foreignObject" === h.p && (i = !1),
        D(null, h, i),
        $(e) && u["s-si"] !== e && u.classList.add((u["s-si"] = e)),
        h.o)
      )
        for (f = 0; f < h.o.length; ++f)
          (d = H(t, h, f, u)), d && u.appendChild(d);
  ...
  I = (t, e, n, l, o, r) => {
    ...
    for (a.shadowRoot && a.tagName === s && (a = a.shadowRoot); o <= r; ++o)
      l[o] &&
        ((i = H(null, n, o, t)), i && ((l[o].m = i), a.insertBefore(i, B(e))));
  },
  V = (t, e, n, s, l) => {
    for (; e <= n; ++e)
      (s = t[e]) &&
  ...
  _ = (t, e, n, s) => {
    ...
    for (; r <= h && i <= p; )
      if (null == u) u = e[++r];
        ...
        ("slot" !== u.p && "slot" !== m.p) || q(u.m.parentNode, !1),
          J(u, m),
          t.insertBefore(u.m, d.m.nextSibling),
          (u = e[++r]),
          (m = s[--p]);
      else if (z(d, f))
        ("slot" !== u.p && "slot" !== m.p) || q(d.m.parentNode, !1),
          J(d, f),
          t.insertBefore(d.m, u.m),
          (d = e[--h]),
          (f = s[++i]);
      else {
        for (a = -1, c = r; c <= h; ++c)
        ...
        a >= 0
          ? ((o = e[a]),
            o.p !== f.p
              ? (l = H(e && e[i], n, a, t))
              : (J(o, f), (e[a] = void 0), (l = o.m)),
            (f = s[++i]))
          : ((l = H(e && e[i], n, i, t)), (f = s[++i])),
          l && G(u.m).insertBefore(l, B(u.m));
      }
    r > h
      ? I(t, null == s[p + 1] ? null : s[p + 1].m, n, s, i, p)
      : i > p && V(e, r, h);
  },
    ...
    null === r
      ? ((i = "svg" === o || ("foreignObject" !== o && i)),
        ...
        null !== s && null !== l
          ? _(n, s, e, l)
          : null !== l
          ? (null !== t.t && (n.textContent = ""),
            I(n, null, e, l, 0, l.length - 1))
          : null !== s && V(s, 0, s.length - 1),
        i && "svg" === o && (i = !1))
      : (a = n["s-cr"])
  ...
  X = (t) => {
    ...
    for (; a < h; a++) {
      if (((e = c[a]), e["s-sr"] && (n = e["s-cr"]) && n.parentNode))
        for (
          s = n.parentNode.childNodes, l = e["s-sn"], i = s.length - 1;
          i >= 0;
          i--
        )
          (n = s[i]),
  ...
  tt = (t, r) => {
    ...
    if (
      ((s = i.tagName),
      a.C && ((u.l = u.l || {}), a.C.map(([t, e]) => (u.l[e] = i[t]))),
      (u.p = null),
      (u.h |= 4),
      (t.O = u),
      (u.m = h.m = i.shadowRoot || i),
      (e = i["s-sc"]),
      (n = i["s-cr"]),
      (l = 0 != (1 & a.h)),
      (o = !1),
      ...
      for (r = 0; r < Q.length; r++)
        if (((t = Q[r]), (e = t.k), t.j)) {
          for (
            s = t.j.parentNode, l = t.j.nextSibling, n = e["s-ol"];
            (n = n.previousSibling);
          ...
          ((!l && s !== e.parentNode) || e.nextSibling !== l) &&
            e !== l &&
            (!e["s-hn"] &&
              e["s-ol"] &&
  ...
  st = (t, e) => {
    ...
    return (
      e &&
        ((t.h |= 256),
        t.T && (t.T.map(([t, e]) => ut(s, t, e)), (t.T = null)),
        (l = ut(s, "componentWillLoad"))),
      n(),
      at(l, () => lt(t, s, e))
    );
  },
  lt = async (t, e, n) => {
    ...
    ot(t, e), o && (o.map((t) => t()), (s["s-rc"] = void 0)), r(), l();
    {
      ...
      0 === e.length
        ? n()
        : (Promise.all(e).then(n), (t.h |= 4), (e.length = 0));
    }
  },
  ot = (t, e, n) => {
    try {
  ...
  it = (t) => {
    ...
    const e = t.$,
      ...
      s = t.P;
    64 & t.h
      ? ut(n, "componentDidUpdate")
      : ((t.h |= 64), dt(e), ut(n, "componentDidLoad"), t.U(e), s || rt()),
      t.L(e),
      t.M && (t.M(), (t.M = void 0)),
      512 & t.h && Bt(() => nt(t, !1)),
      (t.h &= -517);
  ...
  rt = (e) => {
    dt(Wt.documentElement),
      Bt(() => R(Ft, "appload", { detail: { namespace: t } }));
  },
  ut = (t, e, n) => {
    if (t && t[e])
      try {
  ...
  gt = (t, e = {}) => {
    ...
    let h,
      u = !0;
    Object.assign(At, e),
      (At.q = new URL(e.resourcesUrl || "./", Wt.baseURI).href),
      t.map((t) => {
        t[1].map((e) => {
          const n = { h: e[0], S: e[1], F: e[2], D: e[3] };
          ...
          const r = n.S,
            i = class extends HTMLElement {
              constructor(t) {
                super(t),
                  Rt((t = this), n),
                  1 & n.h && t.attachShadow({ mode: "open" });
              }
              connectedCallback() {
                h && (clearTimeout(h), (h = null)),
                  u ? c.push(this) : At.jmp(() => $t(this));
              }
          ...
          (n.V = t[0]),
            l.includes(r) || o.get(r) || (s.push(r), o.define(r, yt(i, n, 1)));
        });
      });
    {
      ...
      null != t && a.setAttribute("nonce", t),
        r.insertBefore(a, i ? i.nextSibling : r.firstChild);
    }
    (u = !1),
      c.length
        ? c.map((t) => t.connectedCallback())
        : At.jmp(() => (h = setTimeout(rt, 30)));
  },
  vt = (t, e) => e,
  St = (t, e, n, s) => {
    n &&
  ...
  Rt = (t, e) => {
    const n = { h: 0, $: t, v: e, N: new Map() };
    return (
      (n.A = new Promise((t) => (n.L = t))),
      (n.I = new Promise((t) => (n.U = t))),
      (t["s-p"] = []),
      (t["s-rc"] = []),
      St(t, n, e.D),
      Mt.set(t, n)
  ...
  Lt = (t, e, n) => {
    ...
    return o
      ? o[s]
      : import(`./${l}.entry.js`).then((t) => (Et.set(l, t), t[s]), Ut);
  },
  Nt = new Map(),
