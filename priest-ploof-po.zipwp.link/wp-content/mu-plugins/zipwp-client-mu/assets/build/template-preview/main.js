      ...
      switch (e.value.param) {
        case "siteLogo":
          ...
          if (((a = e.value.data.dataUri || a), 0 === t.length && "" !== a)) {
            ...
            n.setAttribute("class", "custom-logo-link"),
              n.setAttribute("href", "#"),
            ...
            "" !== r &&
              ((i.style.width = r + "px"), (i.style.maxWidth = r + "px"));
          } else if ("" !== a)
            for (const [n, i] of Object.entries(t)) {
              i.removeAttribute("srcset"), i.setAttribute("src", a);
              const t = e.value.data.width;
              "" !== t &&
                ((i.style.width = t + "px"), (i.style.maxWidth = t + "px"));
            }
          break;
        case "colorPalette":
          ...
          if (0 === n.length) {
            document
              .querySelector("body")
              .classList.remove("zipwp-client-preview-palette");
          ...
          document
            .querySelector("body")
            .classList.add("zipwp-client-preview-palette");
          const c = Object.entries(n)
            .map((e, t) => [
              `--e-global-color-${s[t].replace(/-/g, "")}: ${e[1]};`,
              `${i}${t}: ${e[1]};`,
            ])
            .map((e) => e.join(""))
            .join("");
          ...
          d ||
            ...
            (d.id = "zipwp-client-preview-palette-css"),
            d.setAttribute("rel", "stylesheet"),
            document.head.appendChild(d)),
            (d.innerHTML = `.zipwp-client-preview-palette{ ${c} }`);
          break;
        case "siteTypography":
          ...
          ((e) => {
            ...
            l && (l = `:wght@${l}`),
              o &&
                ...
                (o = o.replace(" ", "+")),
                a.push(`family=${o}${l}`));
            const s = `https://fonts.googleapis.com/css2?${a.join(
              "&"
            )}&display=swap`;
  ...
  window.addEventListener(
    ...
    function (e) {
      if (
        ...
        "zipwpPreviewDispatch" === e.data.call
      ) {
        const t = e.data;
