import { r as t, c as e, h as r, a } from "./p-cc7ce8c7.js";
import { s } from "./p-24f06282.js";
import { d as o } from "./p-5ec5df35.js";
import { r as i, c as n, s as d } from "./p-8266bbed.js";
import { u as l } from "./p-f9c1f513.js";
import { c } from "./p-58517bdd.js";
import { g as h, a as p, s as f, b as u } from "./p-b8e5d313.js";
import { g as m } from "./p-09601e06.js";
...
const w = class {
  constructor(r) {
    t(this, r);
    this.scSetState = e(this, "scSetState", 7);
  }
  handleUpdateSession(t) {
    const { data: e, options: r } = t.detail;
    if (r === null || r === void 0 ? void 0 : r.silent) {
      this.update(e);
    } else {
      this.loadUpdate(e);
    }
  }
  async handleCouponApply(t) {
    const e = t.detail;
    i();
    this.loadUpdate({ discount: { ...(e ? { promotion_code: e } : {}) } });
  }
  handleErrorResponse(t) {
    var e, r;
    if (
      (t === null || t === void 0 ? void 0 : t.code) === "readonly" ||
      ((r =
        (e = t === null || t === void 0 ? void 0 : t.additional_errors) ===
          null || e === void 0
          ? void 0
          : e[0]) === null || r === void 0
        ? void 0
        : r.code) === "checkout.customer.account_mismatch"
    ) {
      c();
    }
    if (
      (t === null || t === void 0 ? void 0 : t.code) ===
      "rest_cookie_invalid_nonce"
    ) {
      l("EXPIRE");
      return;
    }
    if (t === null || t === void 0 ? void 0 : t.message) {
      n(t);
    }
    if (
      (t === null || t === void 0 ? void 0 : t.code) === "http_request_failed"
    ) {
      n(
        wp.i18n.__(
  ...
  async fetch(t = {}) {
    this.loadUpdate({ status: "draft", ...t });
  }
  async update(t = {}, e = {}) {
    var r;
    try {
      s.checkout = await o({
        id: (r = s.checkout) === null || r === void 0 ? void 0 : r.id,
        data: { ...t },
        query: { ...e },
      });
    } catch (t) {
  ...
  render() {
    return r(
      ...
      {
        order: s.checkout,
        onScUpdateLineItems: (t) => this.loadUpdate({ line_items: t.detail }),
      },
      r("slot", null)
    );
  }
...
const v = class {
  ...
  async requestClose(t = "method") {
    const e = this.scRequestClose.emit(t);
    if (e.defaultPrevented) {
      const t = h(this.el, "drawer.denyClose");
      p(this.panel, t.keyframes, t.options);
      return;
    }
    this.hide();
  }
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      await Promise.all([f(this.drawer), f(this.overlay)]);
      this.drawer.hidden = false;
      requestAnimationFrame(() => {
        const e = this.scInitialFocus.emit();
        if (!e.defaultPrevented) {
          if (t) {
      ...
      const e = h(
        this.el,
        `drawer.show${
          this.placement.charAt(0).toUpperCase() + this.placement.slice(1)
        }`
      );
      const r = h(this.el, "drawer.overlay.show");
      await Promise.all([
        p(this.panel, e.keyframes, e.options),
        p(this.overlay, r.keyframes, r.options),
      ]);
      ...
      const e = h(this.el, "drawer.overlay.hide");
      await Promise.all([
        p(this.panel, t.keyframes, t.options),
        p(this.overlay, e.keyframes, e.options),
      ]);
      ...
      r(
        ...
        !this.noHeader &&
          r(
            ...
            {
              part: "header",
              class: this.stickyHeader ? "header__sticky" : "",
            },
            r(
              "slot",
              { name: "header" },
              r(
                ...
                r(
                  "h2",
                  { part: "title", class: "drawer__title", id: "title" },
                  r(
                    "slot",
                    { name: "label" },
        ...
        r(
          "footer",
          { part: "header-suffix", class: "drawer__header-suffix" },
          r("slot", { name: "header-suffix" })
        ),
...
const _ = class {
  constructor(r) {
    t(this, r);
    this.scUpdateError = e(this, "scUpdateError", 7);
    this.error = undefined;
  }
  handleErrorUpdate(t) {
    this.scUpdateError.emit(t);
  }
  render() {
    return !!(d === null || d === void 0 ? void 0 : d.message)
      ? r(
          "sc-alert",
          {
            ...
            type: "danger",
            scrollOnOpen: true,
            open: !!(d === null || d === void 0 ? void 0 : d.message),
            closable: !!(d === null || d === void 0 ? void 0 : d.dismissible),
          },
          (d === null || d === void 0 ? void 0 : d.message) &&
            r("span", { slot: "title", innerHTML: d.message }),
          (m() || []).map((t, e) => r("div", { innerHTML: t, key: e }))
        )
      : null;
  }
  static get watchers() {
    return { error: ["handleErrorUpdate"] };
  }
};
export { w as sc_cart_session_provider, v as sc_drawer, _ as sc_error };
