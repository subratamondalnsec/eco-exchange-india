import { r, c as a, h as c } from "./p-cc7ce8c7.js";
const s =
...
const o = class {
  ...
  render() {
    const r = this.clearable ? "button" : "span";
    return c(
      r,
      {
        part: "base",
      ...
      c("span", { part: "content", class: "tag__content" }, c("slot", null)),
      !!this.clearable &&
        c(
          "svg",
          {
